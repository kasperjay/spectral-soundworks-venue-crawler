...
(async () => {
    ...
    const selectors = ['.timely-event', '.event-excerpt', '.event-item', '.sqs-block-calendar', '.events-collection-list', '.event', '.event-list', '.event-listing', '.sqs-block-events'];
    ...
    // print some candidate nav vs content
